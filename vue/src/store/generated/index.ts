...
import ModuleTestModuletestModuletest from './module-test/moduletest.moduletest'
...
export default { 
  ...
  ModuleTestModuletestModuletest: load(ModuleTestModuletestModuletest, 'moduletest.moduletest'),
